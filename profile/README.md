...
| 이펙티브 자바     | [Item 6 - 불필요한 객체 생성을 피하라](https://k-diger.github.io/blog/2022/08/15/EffectiveJava-item6/) <br> [Item 6 - 불필요한 객체 생성을 피하라]() <br> [Item 7 - 다 쓴 객체 참조를 해제하라](https://k-diger.github.io/blog/2022/08/15/EffectiveJava-item7/) <br> [Item 7 - 다 쓴 객체 참조를 해제하라]() <br> [Item 8 - finalizer 와 cleaner 사용을 피하라](https://k-diger.github.io/blog/2022/08/15/EffectiveJava-item8/) <br> [Item 8 - finalizer 와 cleaner 사용을 피하라]() |
...
|---|-----------------|
|JIWON-JEONG||
|K-Diger| [OAuth와 깐부맺기](https://k-diger.github.io/blog/2022/08/31/OAuth%EC%99%80%EA%B9%90%EB%B6%80%EB%A7%BA%EA%B8%B0/) |
